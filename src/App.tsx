...
import { RegisterArquitectoPage } from '@/pages/auth/RegisterArquitectoPage'
...
import { ArquitectoLayout } from '@/layouts/ArquitectoLayout'
...
// Arquitecto
import { ArquitectoDashboard } from '@/pages/arquitecto/ArquitectoDashboard'
import { MisTramites } from '@/pages/arquitecto/MisTramites'
import { NuevoTramite } from '@/pages/arquitecto/NuevoTramite'
import { DetalleTramite } from '@/pages/arquitecto/DetalleTramite'
...
import { AprobacionArquitectos } from '@/pages/secretaria/AprobacionArquitectos'
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/registro-arquitecto" element={<RegisterArquitectoPage />} />

        {/* ---- Portal Ciudadano (solo consulta) ---- */}
        <Route
          path="/ciudadano"
        ...
        <Route
          path="/arquitecto"
          element={<RequireRole allowed={['ARQUITECTO']}><ArquitectoLayout /></RequireRole>}
        >
          <Route index element={<ArquitectoDashboard />} />
          <Route path="tramites" element={<MisTramites />} />
          <Route path="tramites/nuevo" element={<NuevoTramite />} />
        ...
        >
          ...
          <Route path="arquitectos" element={<AprobacionArquitectos />} />
