        ...
        <button 
          ...
          className={cn(
            ...
            estadoIntegridad?.integra === false 
              ...
              : "bg-gradient-to-r from-primary-600 to-blue-600 shadow-primary-500/30 hover:scale-[1.02]"
          )}
        >
          {verificando ? (
              ...
              return (
                <div key={log.id} className="relative pl-12 md:pl-16 animate-fade-in" style={{ animationDelay: `${index * 50}ms` }}>
                  ...
                  <div className="absolute left-0 top-6 w-8 md:w-12 flex items-center justify-center">
                    <div className="w-4 h-4 rounded-full bg-primary-500 shadow-[0_0_15px_rgba(37,99,235,0.6)] z-10 ring-4 ring-slate-50" />
                  </div>

                  {/* Block Card */}
                  <div className={cn(
                    "glass-card transition-all duration-300 overflow-hidden border",
                    isExpanded ? "border-primary-400/50 shadow-xl shadow-primary-500/10" : "border-surface-border hover:border-primary-300/40"
                  )}>
                    {/* Block Header */}
                    <div 
