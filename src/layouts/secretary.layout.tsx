    ...
    <div className="min-h-screen flex flex-col bg-slate-50 text-blue-950">
      ...
      <header className="sticky top-0 z-50 px-4 md:px-8 h-20 flex items-center justify-between bg-white border-b border-slate-200 shadow-sm transition-all">
        ...
        <div className="flex items-center gap-4">
          {/* Role Badge */}
          <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-full border border-blue-100 bg-blue-500/5">
            <Stamp size={12} className="text-blue-600" />
            <span className="text-blue-600 text-[0.7rem] font-bold">Secretaria</span>
          </div>
            ...
            {dropdown_open && (
              <div className="absolute right-0 mt-3 w-64 rounded-2xl overflow-hidden animate-slide-up origin-top-right bg-white border border-slate-200 shadow-xl z-50 text-left">
                <div className="p-4 border-b border-slate-100">
                  ...
                  <div className="flex items-center gap-1.5 mt-3 px-2 py-1.5 rounded-lg w-max bg-blue-500/5">
                    <Stamp size={12} className="text-blue-600" />
                    <span className="text-blue-600 text-[0.65rem] font-bold uppercase">Secretaria Institucional</span>
                  </div>
                </div>
                <div className="p-2">
      ...
      <div className="fixed top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
        <div className="absolute top-[20%] right-[-10%] w-[40%] h-[50%] rounded-full opacity-[0.03] blur-[120px] bg-blue-600" />
        <div className="absolute bottom-[-20%] left-[5%] w-[35%] h-[45%] rounded-full opacity-[0.02] blur-[100px] bg-blue-600" />
      </div>
    </div>
  )
}
